<x-layouts.app>
<h1 class="text-2xl font-bold">Businesses — Captain final approval</h1>
            ...
            @forelse ($items as $b)
                <tr>
                    ...
                    <td class="p-3 text-right">
                        <form method="POST" action="{{ route('captain.businesses.approve', $b) }}">@csrf
                            <button class="btn-success">Publish business</button>
                        </form>
                    </td>
                </tr>
            @empty
