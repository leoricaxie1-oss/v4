<x-layouts.app>
<h1 class="text-2xl font-bold">Skills/Services — Captain final approval</h1>
            ...
            @forelse ($items as $s)
                <tr>
                    ...
                    <td class="p-3 text-right">
                        <form method="POST" action="{{ route('captain.skills.approve', $s) }}">@csrf
                            <button class="btn-success">Publish listing</button>
                        </form>
                    </td>
                </tr>
            @empty
